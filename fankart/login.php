...
<head>
	...
	<link rel="stylesheet" type="text/css" href="style1login.css">
    ...
    <ul>
      ...
      <li><a href="">Mens</a>
        ...
        <div class="form">
        	...
        	<form class="login" action="login.php?action=login" method="post">
              ...
              <p class="message">Not Registered?<a href="registration.php?action=act">Register</a>
              </p>
        	</form>
        </div>
    </div>
